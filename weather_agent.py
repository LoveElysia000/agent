...
16. **对于超出预报范围的天气预测，必须为每种可能的天气类型显示独立的预测信息**：
    - 为每种天气类型预测独立的温度、湿度、风速等数据
    - 按概率从高到低排序显示，每种类型都包含完整的预测信息
    - 每个天气类型的预测包含：
      - 天气图标🌤️
      - 天气类型和概率百分比
      - 预测的温度🌡️、湿度💧、风速💨
    ...
    **1. ☁️ 多云 (45.2%可能性)**
    ...
    - 💧 预测湿度：62%
    - 💨 预测风速：3.1米/秒
    - 📋 天气状况：多云天气，温度适中，风力3.1米/秒
    - 💡 建议：多雲天气适宜出行，可适当安排户外活动

    **2. ☀️ 晴天 (35.8%可能性)**
    - 🌡️ 预测温度：26.0°C
    - 💧 预测湿度：58%
    - 💨 预测风速：2.8米/秒
    - 📋 天气状况：晴朗天气，温度26.0度，风力2.8米/秒，湿度58%
    - 💡 建议：晴天适合户外活动，注意防晒和补水
    ...
    **3. 🌧️ 雨天 (15.3%可能性)**
    ...
    - 💧 预测湿度：75%
    - 💨 预测风速：3.6米/秒
    - 📋 天气状况：降雨天气，温度24.5度，风力3.6米/秒，湿度75%较高
    - 💡 建议：建议携带雨具，注意地面湿滑
    ...
    **4. ⛈️ 雷雨 (3.7%可能性)**
    ...
    - 💧 预测湿度：80%
    - 💨 预测风速：4.2米/秒
    - 📋 天气状况：雷阵雨天气，温度24.0度，风力4.2米/秒可能较强
    - 💡 建议：雷雨天气避免外出，注意安全
